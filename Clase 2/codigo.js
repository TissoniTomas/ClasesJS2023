...
if (false) {
    console.log(var2);
} // Nunca sera falso por ende nunca se mostrara
...
if(var2 == "Como estas") {
    console.log("La variable var2 es: Como estas");
}
...
if(variabledeprueba = 10) {
    ...
    console.log("la variable es " + variabledeprueba);
}
// En este caso el signo = asigna 10 a variabledeprueba por tal siempre sera TRUE
